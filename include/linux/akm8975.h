...
#define AKM8975C_DRDY_PIN  PM8058_GPIO_PM_TO_SYS((18 - 1)) //PIMC8058 GPIO18("GPIO start number is 0")  //Div2D5-OH-Sensors-GPIO_Settings-03*
//Div2D5-OH-Sensors-SF6_GPIO_Settings-00+{
#elif defined(CONFIG_FIH_PROJECT_SF4Y6)
#define AKM8975C_DRDY_PIN  180 //GPIO180
//Div2D5-OH-Sensors-SF6_GPIO_Settings-00+}
#else
#define AKM8975C_DRDY_PIN  136 //TBD
#endif
//Div2D5-OH-Sensors-GPIO_Settings-00+}
