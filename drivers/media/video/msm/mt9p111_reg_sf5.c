...
struct mt9p111_i2c_reg_conf const init_tbl[] = {
    ...
    //Add for avoid IO power leakage.
    { 0x060E, 0x00FF, WORD_LEN, 0 },	//Fix leakage current in IO power
...
struct mt9p111_i2c_reg_conf const yellow_light_tbl[] = {
    //[Lens Correction 90% 01/28/11 14:04:47]
    {0x3640, 0x0290, WORD_LEN, 0 },// P_G1_P0Q0
    {0x3642, 0x6F8D, WORD_LEN, 0 },// P_G1_P0Q1
    {0x3644, 0x7C10, WORD_LEN, 0 },// P_G1_P0Q2
    {0x3646, 0x9CAD, WORD_LEN, 0 },// P_G1_P0Q3
    {0x3648, 0x8ECF, WORD_LEN, 0 },// P_G1_P0Q4
    {0x364A, 0x0310, WORD_LEN, 0 },// P_R_P0Q0
    {0x364C, 0xD34C, WORD_LEN, 0 },// P_R_P0Q1
    {0x364E, 0x6530, WORD_LEN, 0 },// P_R_P0Q2
    {0x3650, 0x0ECE, WORD_LEN, 0 },// P_R_P0Q3
    {0x3652, 0xC0CF, WORD_LEN, 0 },// P_R_P0Q4
    {0x3654, 0x0330, WORD_LEN, 0 },// P_B_P0Q0
    {0x3656, 0x39AD, WORD_LEN, 0 },// P_B_P0Q1
    {0x3658, 0x282F, WORD_LEN, 0 },// P_B_P0Q2
    {0x365A, 0xEFEE, WORD_LEN, 0 },// P_B_P0Q3
    {0x365C, 0x890B, WORD_LEN, 0 },// P_B_P0Q4
    {0x365E, 0x0410, WORD_LEN, 0 },// P_G2_P0Q0
    {0x3660, 0x98AD, WORD_LEN, 0 },// P_G2_P0Q1
    {0x3662, 0x1B51, WORD_LEN, 0 },// P_G2_P0Q2
    {0x3664, 0x242C, WORD_LEN, 0 },// P_G2_P0Q3
    {0x3666, 0x8FAF, WORD_LEN, 0 },// P_G2_P0Q4
    {0x3680, 0x028E, WORD_LEN, 0 },// P_G1_P1Q0
    {0x3682, 0x90AD, WORD_LEN, 0 },// P_G1_P1Q1
    {0x3684, 0x2F0E, WORD_LEN, 0 },// P_G1_P1Q2
    {0x3686, 0x3E6E, WORD_LEN, 0 },// P_G1_P1Q3
    {0x3688, 0x98B0, WORD_LEN, 0 },// P_G1_P1Q4
    {0x368A, 0x244E, WORD_LEN, 0 },// P_R_P1Q0
    {0x368C, 0x62CC, WORD_LEN, 0 },// P_R_P1Q1
    {0x368E, 0x31CE, WORD_LEN, 0 },// P_R_P1Q2
    {0x3690, 0xAE8C, WORD_LEN, 0 },// P_R_P1Q3
    {0x3692, 0x9030, WORD_LEN, 0 },// P_R_P1Q4
    {0x3694, 0xBD4D, WORD_LEN, 0 },// P_B_P1Q0
    {0x3696, 0x7C0B, WORD_LEN, 0 },// P_B_P1Q1
    {0x3698, 0x1AB0, WORD_LEN, 0 },// P_B_P1Q2
    {0x369A, 0x8C6D, WORD_LEN, 0 },// P_B_P1Q3
    {0x369C, 0xE130, WORD_LEN, 0 },// P_B_P1Q4
    {0x369E, 0x7A4C, WORD_LEN, 0 },// P_G2_P1Q0
    {0x36A0, 0x8F0E, WORD_LEN, 0 },// P_G2_P1Q1
    {0x36A2, 0x7A2C, WORD_LEN, 0 },// P_G2_P1Q2
    {0x36A4, 0x25CA, WORD_LEN, 0 },// P_G2_P1Q3
    {0x36A6, 0xFAEC, WORD_LEN, 0 },// P_G2_P1Q4
    {0x36C0, 0x17D1, WORD_LEN, 0 },// P_G1_P2Q0
    {0x36C2, 0x28AF, WORD_LEN, 0 },// P_G1_P2Q1
    {0x36C4, 0x05D2, WORD_LEN, 0 },// P_G1_P2Q2
    {0x36C6, 0xD3D0, WORD_LEN, 0 },// P_G1_P2Q3
    {0x36C8, 0x9B33, WORD_LEN, 0 },// P_G1_P2Q4
    {0x36CA, 0x7A30, WORD_LEN, 0 },// P_R_P2Q0
    {0x36CC, 0xCFAC, WORD_LEN, 0 },// P_R_P2Q1
    {0x36CE, 0x2EF1, WORD_LEN, 0 },// P_R_P2Q2
    {0x36D0, 0xA9CF, WORD_LEN, 0 },// P_R_P2Q3
    {0x36D2, 0xAAF2, WORD_LEN, 0 },// P_R_P2Q4
    {0x36D4, 0x2F70, WORD_LEN, 0 },// P_B_P2Q0
    {0x36D6, 0xE0AE, WORD_LEN, 0 },// P_B_P2Q1
    {0x36D8, 0x58EF, WORD_LEN, 0 },// P_B_P2Q2
    {0x36DA, 0x3C91, WORD_LEN, 0 },// P_B_P2Q3
    {0x36DC, 0xEE70, WORD_LEN, 0 },// P_B_P2Q4
    {0x36DE, 0x1051, WORD_LEN, 0 },// P_G2_P2Q0
    {0x36E0, 0xB62E, WORD_LEN, 0 },// P_G2_P2Q1
    {0x36E2, 0x6A12, WORD_LEN, 0 },// P_G2_P2Q2
    {0x36E4, 0x0CCF, WORD_LEN, 0 },// P_G2_P2Q3
    {0x36E6, 0xA0B4, WORD_LEN, 0 },// P_G2_P2Q4
    {0x3700, 0xED0C, WORD_LEN, 0 },// P_G1_P3Q0
    {0x3702, 0x18EE, WORD_LEN, 0 },// P_G1_P3Q1
    {0x3704, 0xD2D1, WORD_LEN, 0 },// P_G1_P3Q2
    {0x3706, 0xEE4D, WORD_LEN, 0 },// P_G1_P3Q3
    {0x3708, 0xAEAF, WORD_LEN, 0 },// P_G1_P3Q4
    {0x370A, 0xA22A, WORD_LEN, 0 },// P_R_P3Q0
    {0x370C, 0x6C2E, WORD_LEN, 0 },// P_R_P3Q1
    {0x370E, 0xB771, WORD_LEN, 0 },// P_R_P3Q2
    {0x3710, 0xE4CF, WORD_LEN, 0 },// P_R_P3Q3
    {0x3712, 0xBDAD, WORD_LEN, 0 },// P_R_P3Q4
    {0x3714, 0x796D, WORD_LEN, 0 },// P_B_P3Q0
    {0x3716, 0xE7AB, WORD_LEN, 0 },// P_B_P3Q1
    {0x3718, 0xE8F1, WORD_LEN, 0 },// P_B_P3Q2
    {0x371A, 0x6AAD, WORD_LEN, 0 },// P_B_P3Q3
    {0x371C, 0x5F51, WORD_LEN, 0 },// P_B_P3Q4
    {0x371E, 0xCF8E, WORD_LEN, 0 },// P_G2_P3Q0
    {0x3720, 0x626C, WORD_LEN, 0 },// P_G2_P3Q1
    {0x3722, 0x3B4F, WORD_LEN, 0 },// P_G2_P3Q2
    {0x3724, 0x7E90, WORD_LEN, 0 },// P_G2_P3Q3
    {0x3726, 0x8E93, WORD_LEN, 0 },// P_G2_P3Q4
    {0x3740, 0x3410, WORD_LEN, 0 },// P_G1_P4Q0
    {0x3742, 0xA331, WORD_LEN, 0 },// P_G1_P4Q1
    {0x3744, 0xE653, WORD_LEN, 0 },// P_G1_P4Q2
    {0x3746, 0x6F72, WORD_LEN, 0 },// P_G1_P4Q3
    {0x3748, 0x8512, WORD_LEN, 0 },// P_G1_P4Q4
    {0x374A, 0x758F, WORD_LEN, 0 },// P_R_P4Q0
    {0x374C, 0x9270, WORD_LEN, 0 },// P_R_P4Q1
    {0x374E, 0xB512, WORD_LEN, 0 },// P_R_P4Q2
    {0x3750, 0x6B71, WORD_LEN, 0 },// P_R_P4Q3
    {0x3752, 0xE593, WORD_LEN, 0 },// P_R_P4Q4
    {0x3754, 0x388E, WORD_LEN, 0 },// P_B_P4Q0
    {0x3756, 0x6D90, WORD_LEN, 0 },// P_B_P4Q1
    {0x3758, 0xD211, WORD_LEN, 0 },// P_B_P4Q2
    {0x375A, 0x9A73, WORD_LEN, 0 },// P_B_P4Q3
    {0x375C, 0x5F12, WORD_LEN, 0 },// P_B_P4Q4
    {0x375E, 0x4090, WORD_LEN, 0 },// P_G2_P4Q0
    {0x3760, 0x060D, WORD_LEN, 0 },// P_G2_P4Q1
    {0x3762, 0xDDD4, WORD_LEN, 0 },// P_G2_P4Q2
    {0x3764, 0xDB11, WORD_LEN, 0 },// P_G2_P4Q3
    {0x3766, 0x1735, WORD_LEN, 0 },// P_G2_P4Q4
...
static struct mt9p111_i2c_reg_conf const lc_tbl[] = {
    ...
    { 0x3640, 0x0190, WORD_LEN, 0 },  // P_G1_P0Q0
    { 0x3642, 0x01EE, WORD_LEN, 0 },  // P_G1_P0Q1
    { 0x3644, 0x2111, WORD_LEN, 0 },  // P_G1_P0Q2
    { 0x3646, 0x3A4C, WORD_LEN, 0 },  // P_G1_P0Q3
    { 0x3648, 0x92ED, WORD_LEN, 0 },  // P_G1_P0Q4
    { 0x364A, 0x0370, WORD_LEN, 0 },  // P_R_P0Q0
    { 0x364C, 0x88CD, WORD_LEN, 0 },  // P_R_P0Q1
    { 0x364E, 0x05B1, WORD_LEN, 0 },  // P_R_P0Q2
    { 0x3650, 0x13CD, WORD_LEN, 0 },  // P_R_P0Q3
    { 0x3652, 0xADEE, WORD_LEN, 0 },  // P_R_P0Q4
    { 0x3654, 0x0210, WORD_LEN, 0 },  // P_B_P0Q0
    { 0x3656, 0x394D, WORD_LEN, 0 },  // P_B_P0Q1
    { 0x3658, 0x3930, WORD_LEN, 0 },  // P_B_P0Q2
    { 0x365A, 0x81CD, WORD_LEN, 0 },  // P_B_P0Q3
    { 0x365C, 0x588E, WORD_LEN, 0 },  // P_B_P0Q4
    { 0x365E, 0x0190, WORD_LEN, 0 },  // P_G2_P0Q0
    { 0x3660, 0xEF8C, WORD_LEN, 0 },  // P_G2_P0Q1
    { 0x3662, 0x2571, WORD_LEN, 0 },  // P_G2_P0Q2
    { 0x3664, 0x0B2A, WORD_LEN, 0 },  // P_G2_P0Q3
    { 0x3666, 0xD02D, WORD_LEN, 0 },  // P_G2_P0Q4
    { 0x3680, 0x208C, WORD_LEN, 0 },  // P_G1_P1Q0
    { 0x3682, 0xCD4D, WORD_LEN, 0 },  // P_G1_P1Q1
    { 0x3684, 0xA2E9, WORD_LEN, 0 },  // P_G1_P1Q2
    { 0x3686, 0x824B, WORD_LEN, 0 },  // P_G1_P1Q3
    { 0x3688, 0x80F0, WORD_LEN, 0 },  // P_G1_P1Q4
    { 0x368A, 0x67CD, WORD_LEN, 0 },  // P_R_P1Q0
    { 0x368C, 0x10CE, WORD_LEN, 0 },  // P_R_P1Q1
    { 0x368E, 0x17CE, WORD_LEN, 0 },  // P_R_P1Q2
    { 0x3690, 0x930F, WORD_LEN, 0 },  // P_R_P1Q3
    { 0x3692, 0xEA2F, WORD_LEN, 0 },  // P_R_P1Q4
    { 0x3694, 0x920C, WORD_LEN, 0 },  // P_B_P1Q0
    { 0x3696, 0x27CE, WORD_LEN, 0 },  // P_B_P1Q1
    { 0x3698, 0x4F2E, WORD_LEN, 0 },  // P_B_P1Q2
    { 0x369A, 0x952F, WORD_LEN, 0 },  // P_B_P1Q3
    { 0x369C, 0xA2AF, WORD_LEN, 0 },  // P_B_P1Q4
    { 0x369E, 0x0F09, WORD_LEN, 0 },  // P_G2_P1Q0
    { 0x36A0, 0xCDED, WORD_LEN, 0 },  // P_G2_P1Q1
    { 0x36A2, 0x086F, WORD_LEN, 0 },  // P_G2_P1Q2
    { 0x36A4, 0x882E, WORD_LEN, 0 },  // P_G2_P1Q3
    { 0x36A6, 0x9230, WORD_LEN, 0 },  // P_G2_P1Q4
    { 0x36C0, 0x2F91, WORD_LEN, 0 },  // P_G1_P2Q0
    { 0x36C2, 0x774F, WORD_LEN, 0 },  // P_G1_P2Q1
    { 0x36C4, 0x2672, WORD_LEN, 0 },  // P_G1_P2Q2
    { 0x36C6, 0xD6CF, WORD_LEN, 0 },  // P_G1_P2Q3
    { 0x36C8, 0x9FB3, WORD_LEN, 0 },  // P_G1_P2Q4
    { 0x36CA, 0x1211, WORD_LEN, 0 },  // P_R_P2Q0
    { 0x36CC, 0x382A, WORD_LEN, 0 },  // P_R_P2Q1
    { 0x36CE, 0x0A72, WORD_LEN, 0 },  // P_R_P2Q2
    { 0x36D0, 0x834F, WORD_LEN, 0 },  // P_R_P2Q3
    { 0x36D2, 0xF112, WORD_LEN, 0 },  // P_R_P2Q4
    { 0x36D4, 0x03D1, WORD_LEN, 0 },  // P_B_P2Q0
    { 0x36D6, 0x0710, WORD_LEN, 0 },  // P_B_P2Q1
    { 0x36D8, 0x2592, WORD_LEN, 0 },  // P_B_P2Q2
    { 0x36DA, 0x83B0, WORD_LEN, 0 },  // P_B_P2Q3
    { 0x36DC, 0x8553, WORD_LEN, 0 },  // P_B_P2Q4
    { 0x36DE, 0x3671, WORD_LEN, 0 },  // P_G2_P2Q0
    { 0x36E0, 0x6F2B, WORD_LEN, 0 },  // P_G2_P2Q1
    { 0x36E2, 0x32F2, WORD_LEN, 0 },  // P_G2_P2Q2
    { 0x36E4, 0xBFCF, WORD_LEN, 0 },  // P_G2_P2Q3
    { 0x36E6, 0xAA73, WORD_LEN, 0 },  // P_G2_P2Q4
    { 0x3700, 0x31AD, WORD_LEN, 0 },  // P_G1_P3Q0
    { 0x3702, 0xBA6E, WORD_LEN, 0 },  // P_G1_P3Q1
    { 0x3704, 0xF8F1, WORD_LEN, 0 },  // P_G1_P3Q2
    { 0x3706, 0x56D0, WORD_LEN, 0 },  // P_G1_P3Q3
    { 0x3708, 0x1333, WORD_LEN, 0 },  // P_G1_P3Q4
    { 0x370A, 0x214F, WORD_LEN, 0 },  // P_R_P3Q0
    { 0x370C, 0xE1ED, WORD_LEN, 0 },  // P_R_P3Q1
    { 0x370E, 0xACD1, WORD_LEN, 0 },  // P_R_P3Q2
    { 0x3710, 0x1E70, WORD_LEN, 0 },  // P_R_P3Q3
    { 0x3712, 0x4FD0, WORD_LEN, 0 },  // P_R_P3Q4
    { 0x3714, 0xEEEE, WORD_LEN, 0 },  // P_B_P3Q0
    { 0x3716, 0x972F, WORD_LEN, 0 },  // P_B_P3Q1
    { 0x3718, 0x506E, WORD_LEN, 0 },  // P_B_P3Q2
    { 0x371A, 0x2D90, WORD_LEN, 0 },  // P_B_P3Q3
    { 0x371C, 0xFFCF, WORD_LEN, 0 },  // P_B_P3Q4
    { 0x371E, 0xE34C, WORD_LEN, 0 },  // P_G2_P3Q0
    { 0x3720, 0x960F, WORD_LEN, 0 },  // P_G2_P3Q1
    { 0x3722, 0xE090, WORD_LEN, 0 },  // P_G2_P3Q2
    { 0x3724, 0x48B1, WORD_LEN, 0 },  // P_G2_P3Q3
    { 0x3726, 0x6111, WORD_LEN, 0 },  // P_G2_P3Q4
    { 0x3740, 0x9EEE, WORD_LEN, 0 },  // P_G1_P4Q0
    { 0x3742, 0xA470, WORD_LEN, 0 },  // P_G1_P4Q1
    { 0x3744, 0xEB93, WORD_LEN, 0 },  // P_G1_P4Q2
    { 0x3746, 0xBD51, WORD_LEN, 0 },  // P_G1_P4Q3
    { 0x3748, 0xC332, WORD_LEN, 0 },  // P_G1_P4Q4
    { 0x374A, 0x36AC, WORD_LEN, 0 },  // P_R_P4Q0
    { 0x374C, 0xFECF, WORD_LEN, 0 },  // P_R_P4Q1
    { 0x374E, 0xA353, WORD_LEN, 0 },  // P_R_P4Q2
    { 0x3750, 0x49D0, WORD_LEN, 0 },  // P_R_P4Q3
    { 0x3752, 0x9313, WORD_LEN, 0 },  // P_R_P4Q4
    { 0x3754, 0x2F8E, WORD_LEN, 0 },  // P_B_P4Q0
    { 0x3756, 0x86D1, WORD_LEN, 0 },  // P_B_P4Q1
    { 0x3758, 0xAFD3, WORD_LEN, 0 },  // P_B_P4Q2
    { 0x375A, 0x728D, WORD_LEN, 0 },  // P_B_P4Q3
    { 0x375C, 0xE452, WORD_LEN, 0 },  // P_B_P4Q4
    { 0x375E, 0xA58C, WORD_LEN, 0 },  // P_G2_P4Q0
    { 0x3760, 0x9750, WORD_LEN, 0 },  // P_G2_P4Q1
    { 0x3762, 0xD1F3, WORD_LEN, 0 },  // P_G2_P4Q2
    { 0x3764, 0x47D1, WORD_LEN, 0 },  // P_G2_P4Q3
    { 0x3766, 0xAF13, WORD_LEN, 0 },  // P_G2_P4Q4
    { 0x3782, 0x0418, WORD_LEN, 0 },  // CENTER_ROW
...
static const struct mt9p111_i2c_reg_conf const otp_outdoor_daylight_tbl[] = {
    { 0xAC9A, 0x6D, BYTE_LEN, 0 },
    { 0xAC9B, 0x76, BYTE_LEN, 0 },
    { 0xAC9C, 0x6D, BYTE_LEN, 0 },
};

static const struct mt9p111_i2c_reg_conf const otp_tbl[] = {
    { 0xAC9A, 0x80, BYTE_LEN, 0 },
    { 0xAC9B, 0x7D, BYTE_LEN, 0 },
    { 0xAC9C, 0x82, BYTE_LEN, 0 },
};
//SW5-Multimedia-TH-MT9P111LensCorrection-00+}
...
static struct mt9p111_i2c_reg_conf const iq_tbl[] = {
    ...
    {0xACB2, 0x3C, BYTE_LEN, 0 },	//0x40	//3A 	// AWB_RG_MIN_BRIGHT
    {0xACB3, 0x5A, BYTE_LEN, 0 },	//0x48	//3E 	// AWB_RG_MAX_BRIGHT
    {0xACB6, 0x36, BYTE_LEN, 0 },	//0x3f	//44 	// AWB_BG_MIN_BRIGHT
    {0xACB7, 0x42, BYTE_LEN, 0 },	//0x48 	// AWB_BG_MAX_BRIGHT
    ...
    {0xAC46, 0x019A , WORD_LEN, 0 },	// AWB_LEFT_CCM_0
    {0xAC48, 0xFF92 , WORD_LEN, 0 },	// AWB_LEFT_CCM_1
    {0xAC4A, 0xFFD3 , WORD_LEN, 0 },	// AWB_LEFT_CCM_2
    {0xAC4C, 0xFFA3 , WORD_LEN, 0 },	// AWB_LEFT_CCM_3
    {0xAC4E, 0x012F , WORD_LEN, 0 },	// AWB_LEFT_CCM_4
    {0xAC50, 0x002E , WORD_LEN, 0 },	// AWB_LEFT_CCM_5
    {0xAC52, 0xFFC6 , WORD_LEN, 0 },	// AWB_LEFT_CCM_6
    {0xAC54, 0xFDCC , WORD_LEN, 0 },	// AWB_LEFT_CCM_7
    {0xAC56, 0x036E , WORD_LEN, 0 },	// AWB_LEFT_CCM_8
    {0xAC58, 0x00C6 , WORD_LEN, 0 },	// AWB_LEFT_CCM_R2BRATIO
    {0xAC5C, 0x028F , WORD_LEN, 0 },	// AWB_RIGHT_CCM_0
    {0xAC5E, 0xFF02 , WORD_LEN, 0 },	// AWB_RIGHT_CCM_1
    {0xAC60, 0xFF70 , WORD_LEN, 0 },	// AWB_RIGHT_CCM_2
    {0xAC62, 0xFF77 , WORD_LEN, 0 },	// AWB_RIGHT_CCM_3
    {0xAC64, 0x01B1 , WORD_LEN, 0 },	// AWB_RIGHT_CCM_4
    {0xAC66, 0xFFD9 , WORD_LEN, 0 },	// AWB_RIGHT_CCM_5
    {0xAC68, 0xFFCF , WORD_LEN, 0 },	// AWB_RIGHT_CCM_6
    {0xAC6A, 0xFEAE , WORD_LEN, 0 },	// AWB_RIGHT_CCM_7
    {0xAC6C, 0x0283 , WORD_LEN, 0 },	// AWB_RIGHT_CCM_8
    ...
    {0xAC97, 0x64 , BYTE_LEN, 0 },	// AWB_LEFT_TINT_COEF_FOR_CCM_ROW_0
    ...
    {0xAC9B, 0x7D , BYTE_LEN, 0 },	// AWB_RIGHT_TINT_COEF_FOR_CCM_ROW_1
    ...
    {0xB844, 0x0041, WORD_LEN, 0 },	//2F 	// STAT_AWB_GRAY_CHECKER_OFFSET_Y
    ...
    {0xA81A, 0x0FF4 , WORD_LEN, 0 },  //0x0FF4(5Fps) 	// AE_TRACK_MAX_INT_TIME_ROWS
...
static struct mt9p111_i2c_reg_conf const char_tbl[] = {
	...
	{ 0x337C, 0x0006, WORD_LEN, 0 },  // YUV_YCBCR_CONTROL   ??? not sure is WORD_LEN or BYTE_LEN
...
static const struct mt9p111_i2c_reg_conf const CONST_P2_setting[] = {
	{ 0x098E, 0xBC2B, WORD_LEN, 0 },  //LOGICAL_ADDRESS_ACCESS [LL_GAMMA_NEUTRAL_CURVE_0]
	{ 0xBC2B, 0x00, BYTE_LEN, 0 },	//LL_GAMMA_NEUTRAL_CURVE_0
	{ 0xBC2C, 0x30, BYTE_LEN, 0 },	//LL_GAMMA_NEUTRAL_CURVE_1
	{ 0xBC2D, 0x40, BYTE_LEN, 0 },	//LL_GAMMA_NEUTRAL_CURVE_2
	{ 0xBC2E, 0x54, BYTE_LEN, 0 },	//LL_GAMMA_NEUTRAL_CURVE_3
	{ 0xBC2F, 0x6F, BYTE_LEN, 0 },	//LL_GAMMA_NEUTRAL_CURVE_4
	{ 0xBC30, 0x83, BYTE_LEN, 0 },	//LL_GAMMA_NEUTRAL_CURVE_5
	{ 0xBC31, 0x92, BYTE_LEN, 0 },	//LL_GAMMA_NEUTRAL_CURVE_6
...
#if 1 // Base on SONY Cypershot
    { 0xDC3A, 0x18, BYTE_LEN, 0 },	//SYS_SEPIA_CR
    { 0xDC3B, 0xEE, BYTE_LEN, 0 },	//SYS_SEPIA_CB
#else // Base on FUJI Z808
    { 0xDC3A, 0x15, BYTE_LEN, 0 },	//SYS_SEPIA_CR
    { 0xDC3B, 0xEA, BYTE_LEN, 0 },	//SYS_SEPIA_CB
#endif
    { 0x8404, 0x06, BYTE_LEN, 0 },	// SEQ_CMD	//Div2-SW6-MM-KK-WorkaroundSnapshotFail-0//Div6D1-CL-Camera-autofocus-03*
};
