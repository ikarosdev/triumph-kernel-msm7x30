...
#define YAS529_DEFAULT_DISTORTION           (20)//(15) //Div2D5-OwenHuang-BSP2030_FB0_Power_Consumption-00*
...
#include <mach/gpio.h> //Div2D5-OwenHuang-FB0_Sensors-Porting_New_Sensors_Architecture-00+
#define YLOGD(...) 
#define YLOGI(...) 
...
STATIC int config_yas529_gpio(void); //Div2D5-OwenHuang-FB0_Sensors-Porting_New_Sensors_Architecture-00+
...
#define YAS529_IOC_SET_DRIVER_STATE     (3) //Div2D5-OwenHuang-FB0_Sensors-Porting_New_Sensors_Architecture-00*
...
#if defined(CONFIG_FIH_PROJECT_FB400)
#define YAS529_RST_N 82 
//Div2D5-OwenHuang-BSP2030_SF5_Sensors_Porting-00+{
