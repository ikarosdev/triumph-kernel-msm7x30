...
#if (defined(CONFIG_FIH_PROJECT_FB400) || defined(CONFIG_FIH_PROJECT_SF4V5)) && defined(CONFIG_SENSORS_LTR502ALS) //Div2D5-OwenHuang-BSP2030_SF5_Sensors_Porting-00*
extern void LiteOn_enable_ps(void);
extern void LiteOn_disable_ps(void);
#endif
//Div2D5-OwenHuang-FB0_Sensors-Porting_New_Sensors_Architecture-00+}
